...
const SupportDetails = () => {
    ...
    return (
        <>
            <section className='text-white support' style={{ backgroundColor: 'rgba(41, 10, 71, 0.41)' }}>
                    ...
                    <div className='flex flex-wrap flex-col md:flex-row justify-between items-center py-10 px-2 md:px-6 space-y-6'>
                        <div className='flex flex-col justify-center items-start gap-3 md:gap-5 w-full md:w-[40%]'>
                            ...
                            <p className='text-sm md:text-lg font-medium tracking-wide mt-2'>
                                Our support experts are here to help you. You can check our Resource page to see if you can find an answer to your questions or you can just fill in the form and we will contact you regarding your question.
                            </p>
                            <Link to="#" className='flex flex-row justify-center items-center -ml-4'>
                              <span><TelPhone /></span>
                                <span>+13183741164</span>
